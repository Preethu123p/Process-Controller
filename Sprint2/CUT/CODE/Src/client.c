...
int get_and_validate_input(char *input1)
{
  printf("Enter the Process name:\n");
  scanf("%s", input1);
  return 0;
  
 // return validate_user_name_passwd(input1); 
}
...
int proces_login_msg(char *uname)
{
  int ret; 
  msg_t msg, *rx_msg;
...
void delete_process(char *uname)
{
	int ret;
 	msg_t msg; 
...
int proces_uname_pwd_msg(char *uname)
{
  int ret; 
  msg_t msg, *rx_msg;
...
int main()
{
  ...
  while (1) 
  {
    ...
    printf("1. Enter for Process Controlling \n");
    printf("2. Add a process\n");
    printf("3. Delete a process\n");
    printf("4. Display Menu \n");
    printf("5. Statistical Display \n");
    printf("6. Logout \n");
    ...
    {
      case 1:
	  ret = get_and_validate_input(menu_data_string1);
        ...
        ret = proces_uname_pwd_msg(menu_data_string1);
	...
	case 2:
             ...
             add_process(menu_data_string1);
             break;


	case 3:
		  delete_process(menu_data_string1);
		  break;

      case 4:display_menu();
		  break;
	
	case 5:statistial_display_menu();
		 break;
